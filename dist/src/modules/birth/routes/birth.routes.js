 ...
 */
birthRoutes.post("/", requirePermission("register_birth"), birthController.create.bind(birthController));
/**
 * GET /api/births
 ...
 */
birthRoutes.put("/:id", requirePermission("edit_birth"), birthController.update.bind(birthController));
/**
 * DELETE /api/births/:id
 * Remove parto — apenas se bezerro ainda não foi registrado como animal
 */
birthRoutes.delete("/:id", requirePermission("delete_birth"), birthController.remove.bind(birthController));
export default birthRoutes;
//# sourceMappingURL=birth.routes.js.map