...
mortalityRoutes.get("/animal/:animalId", mortalityController.listByAnimal.bind(mortalityController));
/**
 * GET /api/mortalities/export/xlsx
 * Exporta a lista de mortalidades da fazenda em XLSX
 */
mortalityRoutes.get("/export/xlsx", requirePermission("export_csv"), mortalityController.exportXlsx.bind(mortalityController));
/**
 * POST /api/mortalities
 * Registra morte — owner, farmmanager, veterinarian, admin
 */
mortalityRoutes.post("/", requirePermission("register_mortality"), mortalityController.create.bind(mortalityController));
/**
 * GET /api/mortalities
 ...
 */
mortalityRoutes.put("/:id", requirePermission("edit_mortality"), mortalityController.update.bind(mortalityController));
/**
 * PATCH /api/mortalities/:id/photos
 * Adiciona fotos (URLs já enviadas ao Cloudinary)
 */
mortalityRoutes.patch("/:id/photos", requirePermission("upload_mortality_photo"), mortalityController.addPhotos.bind(mortalityController));
/**
 * DELETE /api/mortalities/:id/photos
 * Remove uma foto especifica do registro pela URL
 */
mortalityRoutes.delete("/:id/photos", requirePermission("upload_mortality_photo"), mortalityController.removePhoto.bind(mortalityController));
export default mortalityRoutes;
//# sourceMappingURL=mortality.routes.js.map