 ...
 */
userRoutes.patch("/:id/activate", requirePermission("activate_user"), userController.activate.bind(userController));
/**
 * PATCH /api/users/:id/deactivate
 * Desativa um usuário (soft delete)
 */
userRoutes.patch("/:id/deactivate", requirePermission("deactivate_user"), userController.deactivate.bind(userController));
/**
 * PATCH /api/users/:id/reset-password
 * Admin redefine senha de qualquer usuário
 */
userRoutes.patch("/:id/reset-password", requirePermission("reset_user_password"), userController.adminResetPassword.bind(userController));
/**
 * DELETE /api/users/:id
 * Remove permanentemente um usuário (apenas admin)
 */
userRoutes.delete("/:id", requirePermission("delete_user"), userController.remove.bind(userController));
