 ...
 * Body: { farmId, email }
 */
authRoutes.post("/forgot-password", forgotPasswordRateLimiter, authController.forgotPassword.bind(authController));
/**
 * POST /api/auth/confirm-reset
 * Confirms reset with code
 * Body: { farmId, email, code, newPassword }
 */
authRoutes.post("/confirm-reset", forgotPasswordRateLimiter, authController.confirmReset.bind(authController));
