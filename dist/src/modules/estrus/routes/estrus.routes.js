...
estrusRoutes.post("/", requirePermission("register_estrus"), estrusController.create.bind(estrusController));
...
estrusRoutes.put("/:id", requirePermission("edit_estrus"), estrusController.update.bind(estrusController));
export default estrusRoutes;
//# sourceMappingURL=estrus.routes.js.map