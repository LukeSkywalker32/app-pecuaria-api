...
pregnancyRoutes.get("/animal/:animalId", pregnancyController.listByAnimal.bind(pregnancyController));
/**
 * POST /api/pregnancies
 * Inicia prenhez — owner, farmmanager, admin
 */
pregnancyRoutes.post("/", requirePermission("edit_pregnancy"), pregnancyController.create.bind(pregnancyController));
/**
 * GET /api/pregnancies
 * Lista prenhezes
 */
 ...
 */
pregnancyRoutes.post("/:id/attempts", requirePermission("register_mating"), pregnancyController.registerAttempt.bind(pregnancyController));
/**
 * POST /api/pregnancies/:id/ultrasounds
 * Registra ultrassom — veterinário, owner, farmmanager, admin
 */
pregnancyRoutes.post("/:id/ultrasounds", requirePermission("register_ultrasound_30"), pregnancyController.registerUltrasound.bind(pregnancyController));
export default pregnancyRoutes;
//# sourceMappingURL=pregnancy.routes.js.map