 ...
 */
pastureRoutes.post("/", requirePermission("create_pasture"), pastureController.create.bind(pastureController));
/**
 * GET /api/pastures
 ...
 */
pastureRoutes.put("/:id", requirePermission("edit_pasture"), pastureController.update.bind(pastureController));
/**
 * PATCH /api/pastures/:id/activate
 * Ativa pasto — owner, farmmanager, admin
 */
pastureRoutes.patch("/:id/activate", requirePermission("edit_pasture"), pastureController.activate.bind(pastureController));
/**
 * PATCH /api/pastures/:id/deactivate
 * Desativa pasto — bloqueia se houver animais
 */
pastureRoutes.patch("/:id/deactivate", requirePermission("edit_pasture"), pastureController.deactivate.bind(pastureController));
/**
 * DELETE /api/pastures/:id
 * Remove pasto — owner, farmmanager, admin
 */
pastureRoutes.delete("/:id", requirePermission("delete_pasture"), pastureController.remove.bind(pastureController));
export default pastureRoutes;
//# sourceMappingURL=pasture.routes.js.map