...
const VALID_STATUS = ["active", "dead", "sold", "quarantine", "treatment"];
const VALID_ORIGINS = ["born", "purchased"];
...
function validateUpdate(data) {
    ...
    if (data.birthDate !== undefined && data.birthDate !== null) {
        if (!isValideDate(data.birthDate)) {
            throw Object.assign(new Error("Data de nascimento inválida. Use formato ISO (YYYY-MM-DD)"), { statusCode: 400 });
        }
        if (!isNotFutureDate(data.birthDate)) {
...
//# sourceMappingURL=animal.validator.js.map