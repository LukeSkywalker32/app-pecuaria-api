 ...
 */
earTagRoutes.post("/", requirePermission("place_ear_tag"), earTagController.place.bind(earTagController));
/**
 * GET /api/ear-tags
 ...
 */
earTagRoutes.patch("/:id/remove", requirePermission("remove_ear_tag"), earTagController.markRemoved.bind(earTagController));
/**
 * DELETE /api/ear-tags/:id
 * Remove registro histórico — somente brincos já removidos — admin only
 */
earTagRoutes.delete("/:id", requirePermission("delete_ear_tag_history"), earTagController.deleteRecord.bind(earTagController));
export default earTagRoutes;
//# sourceMappingURL=earTagHistory.routes.js.map