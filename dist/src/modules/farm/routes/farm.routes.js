 ...
 * Campo do form: "logo"
 */
farmRoutes.patch("/:id/logo", upload.single("logo"), farmController.uploadLogo.bind(farmController));
/**
 * PATCH /api/farms/:id/activate
 * Ativa a fazenda — apenas admin
 */
farmRoutes.patch("/:id/activate", requirePermission("activate_farm"), farmController.activate.bind(farmController));
/**
 * PATCH /api/farms/:id/deactivate
 * Desativa a fazenda — apenas admin
 */
farmRoutes.patch("/:id/deactivate", requirePermission("deactivate_farm"), farmController.deactivate.bind(farmController));
/**
 * DELETE /api/farms/:id
 * Remove permanentemente — apenas admin
 */
farmRoutes.delete("/:id", requirePermission("delete_farm"), farmController.remove.bind(farmController));
