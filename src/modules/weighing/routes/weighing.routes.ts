...
weighingRoutes.get(
   ...
   weighingController.exportAnimalPdf.bind(weighingController),
);
...
weighingRoutes.get(
   ...
   weighingController.exportXlsx.bind(weighingController),
);
...
weighingRoutes.post(
   "/",
   requirePermission("register_weighing"),
   weighingController.create.bind(weighingController),
);
...
weighingRoutes.get(
   "/:id",
   requirePermission("view_weighing"),
   weighingController.getById.bind(weighingController),
);
...
weighingRoutes.put(
   "/:id",
   requirePermission("edit_weighing"),
   weighingController.update.bind(weighingController),
);
 ...
 */
weighingRoutes.delete(
   "/:id",
   requirePermission("delete_weighing"),
   weighingController.remove.bind(weighingController),
);
