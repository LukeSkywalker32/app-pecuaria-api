...
import type { CreateWeighingRequest, UpdateWeighingRequest } from "../types/weighing.types";
...
export function validateCreate(data: CreateWeighingRequest): void {
   // Animal - Obrigatorio
...
export function validateUpdate(data: UpdateWeighingRequest): void {
