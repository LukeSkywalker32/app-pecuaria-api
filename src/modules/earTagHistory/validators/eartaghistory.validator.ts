import type { PlaceEarTagRequest, RemoveEarTagRequest } from "../types/eartaghistory.types";
...
export function validatePlace(data: PlaceEarTagRequest): void {
   // Animal ID
...
export function validateRemove(data: RemoveEarTagRequest): void {
   // Data de remoção
   if (!data.removalDate) {
